...
namespace SchoolMngmnt.Controllers
{
    public class SubjectController : ApiController
    {
        ...
        [EnableCors(origins: "*", headers: "*", methods: "*")]
        [HttpDelete]
        [Route("api/Subject/ArchiveSubject")]
        public StatusResult<TucSubject> ArchiveSubject(string id)
        {
            ...
            if (checkSession.Result.RoleId == 1) // ADMIN or teacher
            {
                ...
                model.SubjectId = id;
                rslt = SpCall.ManageSubject(model, "A", checkSession.Result.UserName);
            }
            else
            {
                rslt.Message = "This user has no permission to archive subject.";
            }
        ...
        public StatusResult<TucSubject> DeleteSubject(string id)
        {
            ...
            {
                rslt.Message = "This user has no permission to delete subject.";
            }
        ...
        public StatusResult<List<TucSubject>> GetSubjectList()
        {
            ...
            {
                rslt = SpCall.GetSubjectList(checkSession.Result.UserName,null,1);
            }
            else
            {
